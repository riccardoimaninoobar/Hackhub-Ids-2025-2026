...
public class RegistrazioneCLI {
    ...
    public Utente run() {
        ...
        while (true) {
            ...
            try {
                handler.validaDati(nickname, email, password);
            } catch (IllegalArgumentException e) {
                // STEP 3.a
            ...
            System.out.println("[4] SYSTEM verifica che non esista già un utente con lo stesso nickname o e-mail...");
            if (handler.verificaUtenteEsistente(nickname, email)) {
                // STEP 4.a
                System.out.println("[4.a.1] SYSTEM segnala presenza utente con stesso nickname e/o e-mail.");
                System.out.println("[4.a.2] Il Visitatore modifica nickname e/o e-mail.");
        ...
        Utente nuovoUtente = handler.registraUtente(nickname, email, password);
